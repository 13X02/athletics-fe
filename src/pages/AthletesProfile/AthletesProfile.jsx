...
const AthleteProfile = () => {
    const id = "A002"; // Use useParams() if dynamic ID is needed
        ...
        const fetchAthleteDetails = async () => {
            try {
                ...
                setEditData({
                    ...
                    coach: response.data.coach ? response.data.coach.name : ''
                });
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.put(`http://localhost:8081/athletes/${id}`, editData);
            setAthlete(editData); // Update athlete state with edited data
            closeModal();
        } catch (error) {
                ...
                <Tab.Group>
                    ...
                    <Tab.Panels className="mt-4">
                        ...
                        <Tab.Panel>
                            ...
                            <div className="mt-8">
                                <RegistrationTabs athleteId={"A002"}/>
                            </div>
                        </Tab.Panel>
                        <Tab.Panel>
                            {/* Wellness Content */}
